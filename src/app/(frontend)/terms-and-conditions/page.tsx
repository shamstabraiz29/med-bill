...
import { getTermsAndConditionsData } from "@/lib/payload";

export const metadata: Metadata = {
  title: "Terms & Conditions | BellMedEx Healthcare RCM Services",
  description:
    "Read the terms of service and legal agreement governing the use of BellMedEx medical billing, coding, and practice management software platforms.",
};
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
          <MotionWrapper variant="fadeIn">
            <div className="flex justify-center">
              <SectionBadge variant="blue" pulse icon={FileText}>
                {hero.badge}
              </SectionBadge>
            </div>
          </MotionWrapper>
          ...
          <MotionWrapper variant="scaleUp">
            <div className="bg-white border border-[#E2E6EC] rounded-2xl p-6 sm:p-10 lg:p-12 shadow-md shadow-blue-900/5 text-left space-y-8">
              ...
              <div className="pt-6 border-t border-[#E2E6EC] text-xs sm:text-sm text-[#475569] space-y-2">
                ...
                <p>
                  For questions regarding our Terms &amp; Conditions or Master Service Agreements, please contact{" "}
