...
const QUALITY_STATS: QualityStat[] = [
  { value: "97.89%", label: "Inpatient Quality Score", icon: Building2 },
  { value: "98.42%", label: "Outpatient Quality Score", icon: Stethoscope },
  { value: "98.99%", label: "Profee Quality Score", icon: UserRound },
  { value: "99%", label: "Overall Score", icon: Award },
];

const CERTIFICATION_BADGES = [
  { label: "AICPA", sublabel: "SOC" },
  { label: "MARCUM", sublabel: "ISO 27001" },
  { label: "ISO 9001:2015", sublabel: "Certified Company" },
  { label: "KLAS", sublabel: "Censinet" },
];

function CodingByTheNumbers() {
  return (
    <>
      <SectionHeader
        ...
        title={
          <span id="medical-coding-by-the-numbers-heading">
            BellMedEx{" "}
            <span className="font-bold text-blue-600">Coding by the Numbers</span>
          </span>
        }
...
function GridTextCell({ badge, title, description }: GridTextCellProps) {
  return (
...
export default function MedicalCodingSecurityCompliance() {
  return (
    <section
