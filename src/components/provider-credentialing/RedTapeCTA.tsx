...
import type { RedTapeCTAData } from "@/payload/types/providerCredentialing";
import { defaultProviderCredentialingData } from "@/lib/defaults/providerCredentialing";

interface RedTapeCTAProps {
  data?: RedTapeCTAData;
}

export default function RedTapeCTA({ data }: RedTapeCTAProps) {
  const content = data || defaultProviderCredentialingData.redTapeCta;
