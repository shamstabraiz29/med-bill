...
import type { PmsGetStartedCtaData } from "@/payload/types/practiceManagementSoftwarePms";

interface PracticeManagementSoftwarePmsGetStartedCtaProps {
  data?: PmsGetStartedCtaData;
}

export default function PracticeManagementSoftwarePmsGetStartedCta({ data }: PracticeManagementSoftwarePmsGetStartedCtaProps) {
  const content = data || defaultPracticeManagementSoftwarePmsData.getStartedCta;
  const rawHighlights = content.highlights && content.highlights.length > 0 ? content.highlights : defaultPracticeManagementSoftwarePmsData.getStartedCta.highlights;
