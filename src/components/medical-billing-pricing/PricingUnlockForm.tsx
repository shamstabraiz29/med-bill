...
export default function PricingUnlockForm({ data }: PricingUnlockFormProps) {
  ...
  const rawRoles = content.roleOptions && content.roleOptions.length > 0 ? content.roleOptions : defaultMedicalBillingPricingData.unlockForm.roleOptions;
  const roleList = rawRoles.map((r: any) => (typeof r === "string" ? r : r.label || ""));

  const rawCollections = content.collectionsOptions && content.collectionsOptions.length > 0 ? content.collectionsOptions : defaultMedicalBillingPricingData.unlockForm.collectionsOptions;
    ...
    try {
      const response = await fetch("/api/forms/submit", {
        ...
        body: JSON.stringify({
          ...
          sourcePage:
            typeof window !== "undefined" ? window.location.pathname : "/medical-billing-pricing-bellmedex",
          role: formData.role,
  ...
  return (
    <section className="relative w-full py-10 sm:py-14 bg-transparent">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Central Unlock Form Card (matching app form cards) */}
          ...
          <div className="bg-white border border-[#E2E6EC] rounded-3xl p-6 sm:p-8 lg:p-9 shadow-md shadow-blue-900/5 text-left relative overflow-hidden">
            ...
            {isSubmitted ? (
              <div className="space-y-4 py-12 text-center">
                ...
                <h3 className="text-xl font-bold text-[#0F172A]">Pricing Details Unlocked!</h3>
                <p className="mx-auto max-w-md text-xs sm:text-sm leading-relaxed text-[#475569]">
                  Thank you, <span className="font-semibold text-[#0F172A]">{formData.name}</span>. A detailed pricing breakdown and fee schedule has been sent to <span className="font-semibold text-[#1D4ED8]">{formData.email}</span>. A billing specialist will also follow up within 1 business hour.
                </p>
                <button
                  type="button"
                ...
                >
                  Unlock pricing for another practice
                </button>
              </div>
            ) : (
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    <label htmlFor="pricing-role" className="text-xs font-semibold text-[#0F172A]">
                  ...
                  <div className="space-y-1.5">
                    <label htmlFor="pricing-org" className="text-xs font-semibold text-[#0F172A]">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    <label htmlFor="pricing-name" className="text-xs font-semibold text-[#0F172A]">
                  ...
                  <div className="space-y-1.5">
                    <label htmlFor="pricing-collections" className="text-xs font-semibold text-[#0F172A]">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    <label htmlFor="pricing-email" className="text-xs font-semibold text-[#0F172A]">
                  ...
                  <div className="space-y-1.5">
                    <label htmlFor="pricing-phone" className="text-xs font-semibold text-[#0F172A]">
                ...
                {/* Row 4: Message */}
                <div className="space-y-1.5">
                  <label htmlFor="pricing-message" className="text-xs font-semibold text-[#0F172A]">
                    Message / Special Requirements
                  </label>
                  <textarea
                    id="pricing-message"
                    rows={4}
                    placeholder="Tell us about your medical specialty, claim volume, or any specific software integration requirements..."
