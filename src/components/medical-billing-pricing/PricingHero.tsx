...
import { LockKeyhole, ShieldCheck, Zap, CheckCircle2 } from "lucide-react";
...
export default function PricingHero({ data }: PricingHeroProps) {
  ...
  const rawHighlights = content.highlights && content.highlights.length > 0 ? content.highlights : defaultMedicalBillingPricingData.hero.highlights;
